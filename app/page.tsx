...
import { 
  ...
  Percent, ArrowUpRight, TrendingUp, Droplets, Sun, Sprout, Send
} from 'lucide-react';
...
export default function HomePage() {
  ...
  const handleNewsletterSubmit = (e: React.FormEvent) => {
    ...
    if (newsletterEmail.trim()) {
      ...
      toastSuccess('Cảm ơn bạn! Mã giảm giá 20.000đ đã được gửi đến email của bạn.');
      setNewsletterEmail('');
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8faf7]">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-forest-900 via-forest-950 to-[#031c0e] text-white pt-10 pb-20 lg:pt-16 lg:pb-28">
        ...
        <div className="absolute inset-0 opacity-[0.06] pointer-events-none bg-[radial-gradient(#a7f3d0_1px,transparent_1px)] [background-size:24px_24px]"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <form onSubmit={handleHeroSearch} className="max-w-lg mx-auto lg:mx-0 pt-1">
                <div className="relative flex items-center bg-forest-950/85 backdrop-blur-xl border border-emerald-500/40 rounded-2xl p-2 shadow-2xl focus-within:border-emerald-400 focus-within:ring-2 focus-within:ring-emerald-400/30 transition">
                  ...
                  <button
                    type="submit"
                    className="px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-forest-600 hover:from-emerald-600 hover:to-forest-700 text-white font-extrabold text-xs shrink-0 shadow-lg transition active:scale-95"
                  >
                    Tìm Hạt Giống
                  </button>
                </div>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-6 border-t border-emerald-900/60 max-w-lg mx-auto lg:mx-0 text-left">
                <div className="bg-forest-900/50 p-3 sm:p-4 rounded-2xl border border-emerald-500/20 backdrop-blur-sm">
            ...
            <div className="lg:col-span-5 relative mt-6 lg:mt-0">
              {/* Main Flower Image Card */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-emerald-600/30 group bg-forest-950">
                <img
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-forest-950 via-forest-950/25 to-transparent"></div>
                ...
                <div className="absolute top-4 left-4 bg-forest-950/90 backdrop-blur-md px-4 py-2 rounded-2xl text-white font-bold text-xs shadow-xl border border-emerald-400/40 flex items-center gap-2">
                  ...
                  <span>Đánh giá 4.9/5★ (1,200+ lượt mua)</span>
                </div>
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white p-4 rounded-2xl bg-forest-900/90 backdrop-blur-xl border border-emerald-500/40 shadow-2xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm sm:text-base font-bold font-serif text-white mt-0.5">
                    ...
                    <div className="text-right shrink-0 ml-2">
                      ...
                      <Link
                        ...
                        className="text-[11px] px-3.5 py-1.5 bg-gradient-to-r from-emerald-500 to-forest-600 hover:from-emerald-600 hover:to-forest-700 text-white rounded-lg font-bold mt-1 inline-block shadow transition"
                      >
                        Mua ngay
                      </Link>
                    </div>
              ...
              <div className="hidden sm:flex items-center gap-3 absolute -bottom-6 -left-6 bg-white text-gray-900 p-3.5 rounded-2xl shadow-2xl border-2 border-emerald-500/40 z-30 max-w-xs transform hover:scale-105 transition duration-300">
                <img
                ...
                <div>
                  <div className="flex items-center gap-1 text-[10px] font-extrabold text-emerald-700 uppercase">
                    <TrendingUp className="w-3 h-3 text-emerald-600" /> Rau Củ Organic
                  </div>
      ...
      {/* 2. VALUE PROPOSITION BAR (4 LUXURY CARDS) */}
      <section className="-mt-8 relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          
          <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-white border border-emerald-900/10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] flex items-center gap-3.5 hover:-translate-y-1 transition duration-300">
            <div className="w-12 h-12 rounded-2xl bg-forest-50 text-forest-700 flex items-center justify-center shrink-0 border border-forest-100">
          ...
          <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-white border border-emerald-900/10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] flex items-center gap-3.5 hover:-translate-y-1 transition duration-300">
            ...
            <div>
              <h4 className="text-xs sm:text-sm font-bold text-gray-900">Tư Vấn Kỹ Thuật</h4>
              <p className="text-[11px] text-gray-500 mt-0.5">Hỗ trợ gieo trồng 24/7</p>
            </div>
          </div>
      ...
      {/* 3. CATEGORIES BENTO SHOWCASE */}
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-2xl mx-auto mb-10">
            <span className="text-xs font-bold text-forest-700 uppercase tracking-widest bg-forest-100/80 px-4 py-1.5 rounded-full border border-forest-200">
              Bộ Sưu Tập Giống Cây Trồng
            </span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-3 sm:gap-4">
            {categories.map((cat) => (
              <Link
                ...
                className="group p-4 rounded-2xl sm:rounded-3xl bg-white border border-emerald-950/5 hover:border-forest-500 shadow-sm hover:shadow-[0_12px_28px_-6px_rgba(22,101,52,0.15)] hover:-translate-y-1 transition-all duration-300 text-center flex flex-col items-center justify-between"
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden bg-forest-50/50 mb-3 border border-forest-100 group-hover:scale-108 transition-transform duration-500 relative shadow-2xs">
                  <img
      ...
      <section className="py-14 bg-gradient-to-r from-forest-950 via-forest-900 to-emerald-950 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4 bg-white/5 p-6 sm:p-8 rounded-3xl border border-white/10 backdrop-blur-md shadow-2xl">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white font-serif">
                ⚡ Flash Sale Hạt Giống Giảm Giá 20% - 30%
              </h2>
            </div>

            {/* Countdown Clock */}
            <div className="flex items-center gap-3">
              <span className="text-xs font-bold text-emerald-200">Kết thúc sau:</span>
              <div className="flex items-center gap-1.5 font-mono text-sm sm:text-base font-extrabold">
                <span className="bg-amber-400 text-forest-950 px-3 py-1.5 rounded-xl shadow-md">
      ...
      <section className="py-16 bg-[#f4f7f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              href="/san-pham"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-forest-800 hover:bg-forest-900 text-white font-bold text-xs sm:text-sm shadow-xl transition transform hover:-translate-y-0.5"
            >
      ...
      {/* 7. EXPERT PLANTING GUIDE - 4 STEPS (NEW HIGH-VALUE SECTION) */}
      <section className="py-16 bg-white border-t border-b border-emerald-950/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="text-xs font-bold text-forest-700 uppercase tracking-widest bg-forest-50 px-4 py-1.5 rounded-full border border-forest-200">
              Bí Quyết Nhà Vườn
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-forest-950 font-serif mt-3">
              4 Bước Gieo Mầm Đạt Tỷ Lệ Nảy Mầm &gt; 85% 🌱
            </h2>
            <p className="text-xs sm:text-sm text-gray-500 mt-2">
              Bất kỳ ai cũng có thể tự tay tạo nên luống rau xanh và vườn hoa rực rỡ ngay tại ban công
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Step 1 */}
            <div className="p-6 rounded-3xl bg-forest-50/60 border border-forest-100 hover:border-forest-300 transition duration-300 group">
              <div className="w-12 h-12 rounded-2xl bg-forest-800 text-white font-bold font-serif text-lg flex items-center justify-center mb-4 shadow-md group-hover:scale-110 transition-transform">
                01
              </div>
              <div className="flex items-center gap-2 text-forest-800 font-bold text-sm mb-1.5">
                <Droplets className="w-4 h-4 text-emerald-600" />
                <h4>Ngâm Ủ Hạt Giống</h4>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                Ngâm hạt trong nước ấm (2 sôi 3 lạnh) từ 4 - 8 tiếng. Sau đó ủ trong khăn ẩm đến khi hạt nứt nanh.
              </p>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-forest-50/60 border border-forest-100 hover:border-forest-300 transition duration-300 group">
              ...
              <div className="flex items-center gap-2 text-forest-800 font-bold text-sm mb-1.5">
                ...
                <h4>Chuẩn Bị Giá Thể Đất</h4>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                Sử dụng đất sạch tơi xốp, trộn kèm phân trùn quế và xơ dừa đã xử lý chát để rễ non dễ hô hấp.
              </p>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-forest-50/60 border border-forest-100 hover:border-forest-300 transition duration-300 group">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                Gieo hạt sâu khoảng 0.5cm, phủ một lớp đất mịn lên trên và để ở nơi thoáng mát, tránh nắng gắt trực tiếp.
              </p>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-forest-50/60 border border-forest-100 hover:border-forest-300 transition duration-300 group">
              ...
              <div className="flex items-center gap-2 text-forest-800 font-bold text-sm mb-1.5">
                ...
                <h4>Tưới Phun Sương &amp; Đón Mầm</h4>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                Tưới ẩm nhẹ nhàng bằng bình phun sương mỗi ngày 2 lần. Sau 3 - 7 ngày mầm cây xanh tốt sẽ vươn lên!
              </p>
            </div>
      ...
      {/* 8. BLOG & GARDENING GUIDES */}
      <section className="py-16 bg-[#f8faf7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              <span className="text-xs font-bold text-forest-700 uppercase tracking-widest bg-forest-100/70 px-4 py-1.5 rounded-full border border-forest-200">
            ...
            <Link
              href="/blog"
              className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-forest-700 hover:text-forest-900"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {INITIAL_POSTS.map((post) => (
              <article
                key={post.id}
                className="group rounded-3xl bg-white border border-emerald-950/5 overflow-hidden hover:shadow-xl transition duration-300 flex flex-col sm:flex-row"
              >
      ...
      {/* 9. CUSTOMER REVIEWS & HARVEST SHOWCASE */}
      <section className="py-16 bg-forest-950 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          
          <div className="text-center max-w-xl mx-auto mb-12">
            <span className="text-xs font-bold text-emerald-400 uppercase tracking-widest bg-forest-900 px-4 py-1.5 rounded-full border border-forest-800">
              Đánh Giá Thực Tế
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold font-serif mt-3 text-white">
              Khu Vườn &amp; Trái Ngọt Từ Khách Hàng 🌸
            </h2>
            <p className="text-xs sm:text-sm text-emerald-200/80 mt-2">
              Hơn 100.000 khách hàng khắp cả nước đã gieo trồng thành công cùng Hạt Giống Nhà Vườn
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            <div className="p-6 sm:p-8 rounded-3xl bg-forest-900/80 border border-forest-800 backdrop-blur-md">
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-forest-900/80 border border-forest-800 backdrop-blur-md">
              ...
              <div className="mt-5 pt-4 border-t border-forest-800 flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white flex items-center gap-1.5">
                    <span>Anh Mai Linh</span>
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                  </h4>
                  <p className="text-[11px] text-emerald-300">Hải Châu, Đà Nẵng</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-forest-900/80 border border-forest-800 backdrop-blur-md">
              ...
              <div className="mt-5 pt-4 border-t border-forest-800 flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white flex items-center gap-1.5">
                    <span>Bác Nguyễn Văn Hải</span>
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                  </h4>
                  <p className="text-[11px] text-emerald-300">Cầu Giấy, Hà Nội</p>
                </div>
              </div>
            </div>
      ...
      {/* 10. NEWSLETTER & VIP CLUB SUBSCRIPTION */}
      <section className="py-14 bg-gradient-to-r from-emerald-900 to-forest-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <span className="text-xs font-bold text-amber-300 uppercase tracking-widest bg-forest-950/60 px-4 py-1.5 rounded-full border border-amber-400/30">
            🎁 Nhận Quà Tặng Người Làm Vườn
          </span>
          <h2 className="text-2xl sm:text-3xl font-extrabold font-serif mt-3 text-white">
            Nhận Cẩm Nang Gieo Trồng Theo Mùa &amp; Voucher 20.000 ₫
          </h2>
          <p className="text-xs sm:text-sm text-emerald-100/90 mt-2 max-w-xl mx-auto">
            Đăng ký nhận thông báo về các giống hoa mới nhất, lịch mùa vụ rau củ hữu cơ và ưu đãi đặc quyền hàng tháng.
          </p>

          <form onSubmit={handleNewsletterSubmit} className="mt-6 max-w-md mx-auto flex items-center gap-2">
            <input
              type="email"
              required
              ...
              className="flex-1 px-4 py-3 rounded-2xl bg-white/10 border border-white/20 text-white placeholder-emerald-200/50 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 backdrop-blur-md"
            />
            <button
              type="submit"
              className="px-6 py-3 rounded-2xl bg-amber-400 hover:bg-amber-500 text-forest-950 font-extrabold text-xs sm:text-sm shadow-lg transition shrink-0 flex items-center gap-1.5"
            >
              <span>Đăng ký</span>
